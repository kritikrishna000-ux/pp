        ...
        >
          ...
          <div>
            ...
            <motion.input
              ...
              className={`w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-cyan-400 transition-all duration-300 transform hover:scale-105 focus:scale-105 ${
                errors.username 
                  ? 'border-red-500' 
                  : isDarkMode 
          ...
          <motion.button 
            ...
            className={`w-full px-4 py-3 text-white rounded-lg font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 transform hover:scale-105 ${
              isDarkMode 
                ? 'bg-cyan-500 border border-cyan-600 hover:bg-cyan-600' 
